...
import AddNewLeave from "./component/leave/AddNewLeave";
...
function App() {
  ...
  return (
    <BrowserRouter>
      ...
      <Authinitializer/>
      <Routes>
        <Route exact path='/' element={user?.role === "admin" ? <HomePageTwo /> : <HomePageOne />} />
        <Route exact path='/employee-dashboard' element={<HomePageOne />} />
        ...
        <Route exact path='/department-list' element={<DepartmentPage/>} />
        <Route exact path='/add-department' element={<AddDepartmentPage/>} />
        <Route exact path='/edit-department/:id' element={<EditDepartment/>} />
        ...
        <Route exact path='/view-profile/:id' element={<ViewProfilePage />} />
